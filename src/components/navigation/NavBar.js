...
const solutions = [
  ...
  { name: 'تسوق', description: "Your customers' data will be safe and secure.", href: '#', icon: ShieldCheckIcon },
  {
    name: 'من نحن',
          ...
          <div className="flex w-full">
            ...
            <div className='hidden lg:flex md:w-full md:justify-between mr-3 md:mr-auto '>
              ...
              <div className=" w-full   md:border-l md:border-gray-200	flex  items-center  justify-start ">
                <a href='#' className="mx-auto hover:text-gray-900 text-sm xl:text-lg active:text-blue-600">الرئيسية</a>
              </div>
              <div className="  w-full  md:border-l md:border-gray-200	flex  items-center  justify-start ">
                <a href='#' className="mx-auto hover:text-gray-900 text-sm xl:text-lg active:text-blue-600">المدونة</a>
              </div>
              <div className="  w-full  md:border-l md:border-gray-200	flex  items-center  justify-start ">
                <a href='#' className="mx-auto hover:text-gray-900 text-sm xl:text-lg active:text-blue-600">تسوق</a>
              </div>
              <div className="  w-full  md:border-l md:border-gray-200	flex  items-center  justify-start ">
                <a href='#' className="mx-auto hover:text-gray-900 text-sm xl:text-lg active:text-blue-600">من نحن</a>
              </div>
              <div className=" w-full flex items-center justify-center">
                <a href='#' className=" hover:text-gray-900 text-sm xl:text-lg active:text-blue-600">اتصل بنا</a>
              </div>

              <form className="lg:flex md:w-full items-center hidden ">
