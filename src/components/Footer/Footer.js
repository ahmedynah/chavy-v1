            ...
            <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
                <div className="lg:w-1/6 md:w-1/2 w-full px-4">
                    ...
                    <nav className="list-none mb-10">
                        <li>
                            <a className="text-gray-600 hover:text-gray-800" href="https://google.com">First Link</a>
                        </li>
                        <li>
                            <a className="text-gray-600 hover:text-gray-800"href="https://google.com">Second Link</a>
                        </li>
                        <li>
                            <a className="text-gray-600 hover:text-gray-800"href="https://google.com">Third Link</a>
                        </li>
                        <li>
                            <a className="text-gray-600 hover:text-gray-800"href="https://google.com">Fourth Link</a>
                        </li>
                    </nav>
                </div>
                <div className="lg:w-1/6 md:w-1/2 w-full px-4">
        ...
        <div className="border-t border-gray-200">
            <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
                ...
                <span className="inline-flex lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto">
                    ...
                    <a className="ml-3 text-gray-500"href="https://google.com">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
